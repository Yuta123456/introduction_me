...
class FasionsContent extends React.Component {
    render() {
        return (
            <div>
                <div className="container">
                    <h1 className="title has-text-primary">Fasions</h1>
                    ...
                    <section className="columns has-centered">
                        ...
                        <div className="column"><img src = {pic2} width = "50%" height = "30%"></img></div>
                        <div className="column"><img src = {pic3} width = "50%" height = "50%"></img></div>
                    </section>
                    <section className="columns has-centered">
                        <div className="column"><img src = {pic4} width = "50%" height = "30%"></img></div>
                        <div className="column"><img src = {pic5} width = "60%" height = "30%"></img></div>
                        <div className="column"><img src = {pic6} width = "50%" height = "50%"></img></div>
                    </section>
                    <section className="columns has-centered">
                        <div className="column"><img src = {pic7} width = "30%" height = "30%"></img></div>
                        <div className="column"><img src = {pic8} width = "30%" height = "30%"></img></div>
                    </section>
                </div>
            </div>
        );
